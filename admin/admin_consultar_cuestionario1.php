...
<form action="admin_consultar_cuestionario1.php" method="post" name="form_consulta">
    <label>Ingresa el código del alumno a buscar:</label>
    <input type="text" name="codigo" id="codigo" placeholder="Código">
    <input type="submit" value="Buscar" placeholder="Código">
</form>
